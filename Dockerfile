...
COPY kafka-elastic-sink-connector/target/kafka-elastic-sink-connector-1.0-SNAPSHOT.jar \
  kc-plugins/elastic-sink-connector/kafka-elastic-sink-connector-1.0-SNAPSHOT.jar
COPY debezium/target/debezium-parent-0.8.0-SNAPSHOT-tests.jar \
  kc-plugins/debezium-connector-postgres/debezium-parent-0.8.0-SNAPSHOT-tests.jar
