...
COPY kc-plugins/debezium-core-1.8.1.Final.jar /etc/kafka-connect/plugins/debezium-connector-postgres/
COPY kc-plugins/debezium-connector-postgres-1.8.1.Final.jar /etc/kafka-connect/plugins/debezium-connector-postgres/
